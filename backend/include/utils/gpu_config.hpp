...
public:
     ...
     */
    bool saveConfig(const std::string& configPath = "backend/config/gpu.json") const;
     ...
     */
    void setModelConfig(const std::string& modelName, const ModelGPUConfig& config);
...
private:
    ...
    static const std::string MODEL_COQUI;
};
