...
/**
 * AudioBufferManager - Efficient audio buffer management for streaming transcription
 * 
...
public:
    ...
    struct BufferConfig {
        ...
        size_t maxIdleTimeMs = 30000;          // Max idle time before cleanup in milliseconds
...
public:
     ...
     */
    explicit AudioBufferManager(const BufferConfig& config = BufferConfig());
...
private:
    ...
    std::unordered_map<uint32_t, std::unique_ptr<UtteranceBuffer>> utteranceBuffers_;
