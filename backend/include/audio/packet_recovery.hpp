...
struct PacketInfo {
  ...
  PacketInfo()
      : sequenceNumber(0), dataSize(0), acknowledged(false), retryCount(0) {}
...
public:
   ...
   */
  size_t getOrderedChunks(std::vector<AudioChunk> &chunks,
                          size_t maxChunks = 10);
...
public:
   ...
   * @return true if chunk processed successfully
   */
  bool processIncomingChunk(const AudioChunk &chunk,
