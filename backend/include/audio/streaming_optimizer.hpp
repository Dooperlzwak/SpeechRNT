...
public:
     ...
     */
    bool initialize(int sampleRate = 16000, int channels = 1, int targetLatencyMs = 50);
     ...
     */
    bool processStream(const std::vector<float>& audioData, std::vector<AudioChunk>& outputChunks);
...
public:
     ...
     * @return true if initialization successful
     */
    bool initialize(size_t maxMessageSize = 65536, bool compressionEnabled = true);
     ...
     */
    bool optimizeForTransmission(const std::vector<float>& audioData, 
